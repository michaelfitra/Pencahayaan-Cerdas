...
class PersonCounter:
    def __init__(self, show_line=False, mqtt_broker="localhost"):
        ...
        if self.use_cuda:
            ...
            # Set GPU untuk komputasi tertentu
    ...
    def initialize_models(self):
        try:
            ...
            # Disable gradients untuk inferensi
    ...
    def process_frame(self, frame):
        try:
            # Konversi frame ke tensor dan pindahkan ke GPU jika tersedia
            if self.use_cuda:
            ...
            # Pindahkan hasil ke CPU sebelum ekstraksi box
            if self.use_cuda:
            ...
            # Update MQTT publish dengan validasi tambahan
            ...
            if current_time - self.last_mqtt_publish >= self.mqtt_publish_interval:
                try:
                    ...
                    print(f"Error publishing count: {e}")
